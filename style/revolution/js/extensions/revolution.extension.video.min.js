  ...
  jQuery.extend(!0, a, {
      ...
      switch (n.videotype) {
        ...
        case "html5":
          ...
          var p = "html5" == n.audio ? "audio" : "video",
            ...
            c = v[0];
          if (
            (punchgs.TweenLite.to(v, 0.3, {
              autoAlpha: 1,
              display: "block",
              ease: punchgs.Power3.easeInOut,
            }),
            "on" == n.forcerewind && !e.hasClass("videoisplaying"))
          )
            try {
    ...
    playVideo: function (e, i) {
      ...
      switch (o.videotype) {
        ...
        case "vimeo":
          if (0 == e.find("iframe").length)
            e.removeData("vimeoplayer"),
              e.append(e.data("videomarkup")),
              s(e, i, !0);
          else if (e.hasClass("rs-apiready")) {
            var l,
              u = e.find("iframe").attr("id");
            e.data("vimeoplayer")
              ? (l = e.data("vimeoplayer"))
              : ((l = new Vimeo.Player(u)), e.data("vimeoplayer", l)),
              l.getPaused()
                ? setTimeout(function () {
    ...
    prepareCoveredVideo: function (e, t) {
      if (
        void 0 === t.data("vimeoid") ||
        void 0 !== t.data("vimeoplayerloaded")
      ) {
        var i = {};
        if (
          ((i.ifr = t.find("iframe, video")),
          (i.asp = t.data("aspectratio")),
          (i.wa = i.asp.split(":")[0]),
          (i.ha = i.asp.split(":")[1]),
          (i.vd = i.wa / i.ha),
          0 === e.conw || 0 === e.conh)
    ...
    manageVideoLayer: function (e, r, n, l) {
      ...
      var u = e.data(),
        ...
        m =
          "auto" === u.videopreload ||
          "canplay" === u.videopreload ||
          "canplaythrough" === u.videopreload ||
          "progress" === u.videopreload
            ? "auto"
            : u.videopreload,
        y = u.videomp4,
        f = u.videowebm,
        ...
        x =
          void 0 != y || void 0 != f
            ? "html5"
            : void 0 != c && String(c).length > 1
            ? "youtube"
            : void 0 != g && String(g).length > 1
            ? "vimeo"
            : "none",
        V = "html5" == u.audio ? "audio" : "video",
        L =
          "html5" == x && 0 == e.find(V).length
            ? "html5"
            : "youtube" == x && 0 == e.find("iframe").length
            ? "youtube"
            : "vimeo" == x && 0 == e.find("iframe").length
            ? "vimeo"
            : "none";
      switch (((k = !0 === u.nextslideatend ? "" : k), (u.videotype = x), L)) {
        case "html5":
          ...
          var C = "";
          "video" === V &&
            (a.is_mobile() || a.isSafari11()) &&
            ("on" === u.autoplay || "true" === u.autoplay || !0 === u.autoplay
              ? (C = "muted playsinline autoplay")
              : (1 != u.videoinline &&
                  "true" !== u.videoinline &&
                  1 !== u.videoinline) ||
                (C += " playsinline"));
          var P =
            ...
            m +
            '">';
          "auto" == m && (r.mediapreload = !0),
            "video" === V
              ? (void 0 != f &&
                  "firefox" == a.get_browser().toLowerCase() &&
                  (P = P + '<source src="' + f + '" type="video/webm" />'),
                void 0 != y &&
                  (P = P + '<source src="' + y + '" type="video/mp4" />'),
                void 0 != h &&
                  (P = P + '<source src="' + h + '" type="video/ogg" />'))
              : "audio" === V &&
                (void 0 != y &&
                  (P = P + '<source src="' + y + '" type="audio/mpeg" />'),
                void 0 != h &&
                  (P = P + '<source src="' + h + '" type="audio/ogg" />')),
            (P = P + "</" + V + ">");
          var I = "";
          ("true" !== b && !0 !== b) ||
            (I =
            ...
            "controls" == w &&
              (P =
                ...
                I +
                "</div>"),
            e.data("videomarkup", P),
            e.append(P),
            ((i && 1 == e.data("disablevideoonmobile")) || a.isIE(8)) &&
              e.find(V).remove(),
            e.find(V).each(function (t) {
              var i = this,
                o = jQuery(this);
        ...
        case "youtube":
          (T = "https"),
            "none" == w &&
              -1 ==
                (v = v.replace("controls=1", "controls=0"))
                  .toLowerCase()
                  .indexOf("controls") &&
              (v += "&controls=0"),
            (!0 === u.videoinline ||
              "true" === u.videoinline ||
              1 === u.videoinline ||
              e.hasClass("rs-background-video-layer")) &&
              (v += "&playsinline=1");
          var _ = t(e.data("videostartat")),
            S = t(e.data("videoendat"));
          -1 != _ && (v = v + "&start=" + _), -1 != S && (v = v + "&end=" + S);
      ...
      if (void 0 != u.videoposter && u.videoposter.length > 2 && !Q)
        0 == e.find(".tp-videoposter").length &&
          e.append(
  ...
  var d = function (e, t, a) {
      ...
      if (
        ...
        switch (s.videotype) {
              ...
              events: {
                  ...
                  if (i.data == YT.PlayerState.PLAYING)
                    punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, {
                      ...
                      !0 === o.globalmute
                        ? C.mute()
                        : (C.unMute(),
                          C.setVolume(parseInt(e.data("volume"), 0) || 75)),
                      (o.videoplaying = !0),
                      v(e, o),
                      y ? o.c.trigger("stoptimer") : (o.videoplaying = !1),
                      o.c.trigger(
                    ...
                    n ||
                      ...
                      (1 === e.data("bgvideo")
                        ...
                        : punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.1, {
                            autoAlpha: 1,
                            force3D: "auto",
                            ease: punchgs.Power3.easeInOut,
                          }),
                ...
                onReady: function (o) {
                  ...
                  if (r || a.isSafari11()) {
                    ...
                    (e.hasClass("rs-background-video-layer") || l) &&
                      ((r && n) ||
                        ((d = !0),
                        C.setVolume(0),
                        e.data("volume", "mute"),
                  ...
                  if (
                    ...
                    void 0 != u && o.target.setPlaybackRate(parseFloat(u)),
          ...
          case "vimeo":
            ...
            h = (h =
              void 0 != b.player_id
                ? h.replace(b.player_id, g)
                : h + "&player_id=" + g).replace(/&api=0|&api=1/g, "");
            var k = a.is_mobile(),
              x = k || a.isSafari11(),
            ...
            if (
              (e.data("vimeoplayer")
                ? (L = e.data("vimeoplayer"))
                : ((L = new Vimeo.Player(g)), e.data("vimeoplayer", L)),
              x)
            ) {
              var P;
              if (V) P = !0;
            ...
            L.on("loaded", function (t) {
              ...
              L.getVideoWidth().then(function (t) {
                (a.width = t),
                  void 0 !== a.width &&
                    void 0 !== a.height &&
                    (e.data("aspectratio", a.width + ":" + a.height),
                    e.data("vimeoplayerloaded", !0),
                    n(o, e));
              }),
              ...
              L.on("play", function (t) {
                e.data("nextslidecalled", 0),
                  ...
                  !0 === o.globalmute
                    ? L.setVolume(0)
                    : L.setVolume(parseInt(e.data("volume"), 0) / 100 || 0.75),
                  a.toggleState(s.videotoggledby);
              }),
              ...
              L.on("pause", function (t) {
                (("on" == e.data("showcoveronpause") &&
                  ...
                  (1 === e.data("bgvideo") &&
                    e.find(".rs-fullvideo-cover").length > 0)) &&
                  (1 === e.data("bgvideo")
                    ? punchgs.TweenLite.to(e.find(".rs-fullvideo-cover"), 0.1, {
                        autoAlpha: 1,
                        force3D: "auto",
                        ease: punchgs.Power3.easeInOut,
                      })
              ...
              e.data("startvideonow") &&
                (L.play(),
                -1 != (_ = t(e.data("videostartat"))) && L.setCurrentTime(_)),
              e.data("videolistenerexist", 1);
        }
      else {
        var _ = t(e.data("videostartat"));
    ...
    p = function (e, o, n) {
      ...
      if (
        ...
        y.data("metaloaded", 1),
        1 != e.data("bgvideo") ||
          ("none" !== s.videoloop && !1 !== s.videoloop) ||
          (h = !1),
        void 0 == g.attr("control") &&
        ...
        if (1 == e.data("forcecover") || 1 == e.data("bgvideo")) {
          ...
          (void 0 !== b && 1 != b.split(":").length) ||
            e.data("aspectratio", "16:9"),
            a.prepareCoveredVideo(o, e);
      ...
      void 0 != w &&
        ...
        void 0 != T &&
          d(T, "click", function () {
            0 == m.muted
              ? ((m.muted = !0), (T.innerHTML = "Unmute"))
              : ((m.muted = !1), (T.innerHTML = "Mute"));
          }),
        void 0 != k &&
          k &&
          d(k, "click", function () {
            m.requestFullscreen
              ...
              ? m.mozRequestFullScreen()
              : m.webkitRequestFullscreen && m.webkitRequestFullscreen();
          }),
        void 0 != x &&
          (d(x, "change", function () {
        ...
        d(m, "play", function () {
          ...
          (t = void 0 != t && "mute" != t ? parseFloat(t) / 100 : t),
            a.is_mobile() ||
              a.isSafari11() ||
              (!0 === o.globalmute ? (m.muted = !0) : (m.muted = !1),
              t > 1 && (t /= 100),
              "mute" == t ? (m.muted = !0) : void 0 != t && (m.volume = t)),
          ...
          v(e, o),
            h && "audio" != i
              ? ((o.videoplaying = !0),
                ...
                o.c.trigger("revolution.slide.onvideoplay", r(m, "html5", s)))
              : ((o.videoplaying = !1),
                "audio" != i && o.c.trigger("starttimer"),
                o.c.trigger("revolution.slide.onvideostop", r(m, "html5", s))),
            punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, {
              autoAlpha: 0,
              force3D: "auto",
              ease: punchgs.Power3.easeInOut,
          ...
          void 0 != d && (d.innerHTML = "Pause"),
            void 0 != n && m.muted && (n.innerHTML = "Unmute"),
            a.toggleState(s.videotoggledby);
        }),
        ...
        d(m, "ended", function () {
          l(),
            ...
            (o.videoplaying = !1),
            c(e, o),
            "audio" != p && o.c.trigger("starttimer"),
            o.c.trigger(
              "revolution.slide.onvideostop",
              r(m, "html5", e.data())
            ),
