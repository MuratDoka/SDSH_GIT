$(document).ready(function () {
  ...
  $(".basic-slider").each(function (index, element) {
    ...
    $this
      ...
      .addClass("basic-slider-pagination-" + index);
  ...
  $(".swiper-col3").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-col3-pagination-" + index);
  ...
  $(".swiper-col3-20").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-col3-20-pagination-" + index);
  ...
  $(".swiper-col4").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-col4-pagination-" + index);
  ...
  $(".swiper-col6").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-col6-pagination-" + index);
  ...
  $(".swiper-auto").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-auto-pagination-" + index);
  ...
  $(".swiper-auto-tab").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-auto-tab-pagination-" + index);
  ...
  $(".swiper-full").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-full-pagination-" + index);
  ...
  $(".swiper-full-single").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-full-single-pagination-" + index);
  ...
  $(".swiper-col3-full").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-col3-full-pagination-" + index);
  ...
  $(".swiper-auto-full").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-auto-full-pagination-" + index);
  ...
  $(".swiper-auto-centered").each(function (index, element) {
    ...
    $this
      .find(".swiper-pagination")
      .addClass("swiper-auto-centered-pagination-" + index);
  ...
  var instagramFeed = new Instafeed({
    ...
    template:
      '<div class="item col-1-5"><figure class="overlay overlay3"><a href="{{link}}" target="_blank"><img src="{{image}}" /><figcaption class="d-flex"><div class="align-self-center mx-auto"><i class="fa fa-instagram"></i></div></figcaption></figure></div>',
    after: function () {
  ...
  var instagramFeed2 = new Instafeed({
    ...
    resolution: "low_resolution",
    template:
      '<div class="item col-6 col-sm-4 col-md-2"><figure class="overlay overlay3"><a href="{{link}}" target="_blank"><img src="{{image}}" /><figcaption class="d-flex"><div class="align-self-center mx-auto"><i class="fa fa-instagram"></i></div></figcaption></figure></div>',
    after: function () {
  ...
  var instagramFeed3 = new Instafeed({
    ...
    resolution: "low_resolution",
    template:
      '<div class="swiper-slide"><figure class="overlay overlay3"><a href="{{link}}" target="_blank"><img src="{{image}}" /><figcaption class="d-flex"><div class="align-self-center mx-auto"><i class="fa fa-instagram"></i></div></figcaption></figure></div>',
    after: function () {
  ...
  var instagramFeed5 = new Instafeed({
    ...
    resolution: "low_resolution",
    template:
      '<div class="item col-6 col-sm-4"><figure class="overlay overlay3"><a href="{{link}}" target="_blank"><img src="{{image}}" /><figcaption class="d-flex"><div class="align-self-center mx-auto"><i class="fa fa-instagram"></i></div></figcaption></figure></div>',
    after: function () {
  ...
  $("#flickrfeed").jflickrfeed({
    ...
    itemTemplate:
      '<div class="item col-1-5"><figure class="overlay overlay3"><a href="{{image_b}}" target="_blank"><span class="bg"></span><img src="{{image_q}}" alt="{{title}}" /><figcaption class="d-flex"><div class="align-self-center mx-auto"><i class="fa fa-flickr"></i></div></figcaption></figure></div>',
  });
  $("#flickrfeed2").jflickrfeed({
    ...
    itemTemplate:
      '<div class="item col-6 col-sm-4 col-md-2"><figure class="overlay overlay3"><a href="{{image_b}}" target="_blank"><span class="bg"></span><img src="{{image_q}}" alt="{{title}}" /><figcaption class="d-flex"><div class="align-self-center mx-auto"><i class="fa fa-flickr"></i></div></figcaption></figure></div>',
  });
  $("#flickrfeed3").jflickrfeed(
    {
      ...
      itemTemplate:
        '<div class="swiper-slide"><figure class="overlay overlay3"><a href="{{image_b}}" target="_blank"><span class="bg"></span><img src="{{image_q}}" alt="{{title}}" /><figcaption class="d-flex"><div class="align-self-center mx-auto"><i class="fa fa-flickr"></i></div></figcaption></figure></div>',
    },
    function (data) {
  ...
  $("#flickrfeed4").jflickrfeed({
    ...
    itemTemplate:
      '<div class="item col-6 col-sm-4"><figure class="overlay overlay3"><a href="{{image_b}}" target="_blank"><span class="bg"></span><img src="{{image_q}}" alt="{{title}}" /><figcaption class="d-flex"><div class="align-self-center mx-auto"><i class="fa fa-flickr"></i></div></figcaption></figure></div>',
  });
  /*-----------------------------------------------------------------------------------*/
  /*	IMAGE ICON HOVER
    /*-----------------------------------------------------------------------------------*/
  ...
  $cubegrid.on("onAfterLoadMore.cbp", function (event, newItemsAddedToGrid) {
    $(
      ".cbp-item-load-more .overlay > a, .cbp-item-load-more .overlay > span"
  ...
  $cubegridlarge.on(
    "onAfterLoadMore.cbp",
    function (event, newItemsAddedToGrid) {
      // first destroy the gallery
      $lg.data("lightGallery").destroy(true);
      // reinit the gallery
      $lg.lightGallery({
  ...
  $.scrollUp({
    ...
    scrollText:
      '<span class="btn btn-square btn-full-rounded btn-icon"><i class="fa fa-chevron-up"></i></span>',
