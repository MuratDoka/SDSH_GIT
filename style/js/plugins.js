            ...
            o
              ...
              .on({
                "show.smapi": function (e, s) {
                  ...
                  o && o.css("background-color", i.css("background-color")),
                    i.parent().addClass("show"),
                    a.opts.keepHighlighted &&
                      i.dataSM("level") > 2 &&
                      i.prevAll("a").addClass(a.opts.bootstrapHighlightClasses);
                },
                "hide.smapi": function (e, s) {
                  var i = t(s);
                  i.parent().removeClass("show"),
                    a.opts.keepHighlighted &&
                      i.dataSM("level") > 2 &&
                      i
                        .prevAll("a")
                        .removeClass(a.opts.bootstrapHighlightClasses);
                },
              }),
              (a = o.data("smartmenus")),
              e(),
    ...
    return a.jQuery && d instanceof a.jQuery
      ...
      ? h.getInstanceByElement(d) instanceof h
        ...
        : ((e = b()),
          ...
          (f.dict = {
            markedAsSpamError:
              "Mesazhi juaj u shënua si i padëshiruar dhe nuk u dërgua! Rregulloni mesazhin tuaj!",
            markedAsSpamServerError:
              "Mesazhi juaj u shënua si SPAM dhe nuk u dërgua.",
            sendSuccess:
              "Ne kemi marrë kërkesën tuaj. Qëndroni të sintonizuar, do të kthehemi tek ju shumë shpejt.",
            sendError:
              "Serveri i postës ka pësuar një gabim. Ju lutemi provoni përsëri.",
            httpRequestError:
              "[%s] Pati një problem me marrjen e përgjigjes nga serveri i postës",
            timeoutError:
              "Kërkesa juaj kishte skaduar. Ju lutemi provoni përsëri.",
            parseResponseError:
              "Përgjigja nga serveri i postimeve ishte e paqartë. Ju lutemi kontaktoni administratorin.",
            httpRequestConnectionError:
              "Nuk mundëm të lidheshim me serverin për shkak të gabimit të lidhjes. Ju lutemi provoni përsëri.",
          }),
        ...
        createMarkup: function () {
          ...
          if (
            ("singlePage" === o.type &&
              ...
              (i = " cbp-popup-singlePage-" + o.options.singlePageAnimation),
            (o.wrap = e("<div/>", {
            ...
            e("<div/>", { class: "cbp-popup-loadingBox" }).appendTo(o.wrap),
            ...
            o.options.singlePageCounter &&
              ((o.counter = e(o.options.singlePageCounter).appendTo(
                o.navigation
              )),
              o.counter.text("")),
              o.content.on(
            ...
            try {
              ...
              t.addEventListener("testPassive", null, s),
                t.removeEventListener("testPassive", null, s);
            } catch (c) {}
            var p =
...
jQuery(document).ready(function ($) {
  ...
  $("#slide-portfolio")
    .find("a.slide-portfolio-item")
    .on("click", function (event) {
      event.preventDefault();
      var selected_member = $(this).data("type");
      $(".slide-portfolio-item-content." + selected_member + "").addClass(
        "slide-in"
      );
  ...
  $(document).on(
    "click",
    ".slide-portfolio-overlay, .slide-portfolio-item-content-close",
    function (event) {
      event.preventDefault();
...
/*	28. BACKSTRETCH
/*-----------------------------------------------------------------------------------*/
/*! Backstretch - v2.1.15 - 2017-06-22\n* Copyright (c) 2017 Scott Robbin;* Fork of improvements - by Daniel Cohen Gindi (danielgindi@gmail.com) Licensed MIT */ !(function (
  a,
  b,
  c
) {
    ...
    (p.loadYoutubeAPI = function () {
      if (!b.YT) {
        ...
        var c = setInterval(function () {
          b.YT &&
            b.YT.loaded &&
            (a(b).trigger("youtube_api_load"), clearTimeout(c));
        }, 50);
      }
    });
  var q = function () {
...
!(function (t, i, s) {
          ...
          return (
            ...
            (h = t + ((c * c) / (2 * r)) * (l < 0 ? -1 : 1)) < o
              ...
              : h > 0 &&
                ((h = n ? (n / 2.5) * (c / 8) : 0),
                (a = (l = s.abs(t) + h) / c)),
            { destination: s.round(h), duration: a }
          );
        });
      var h = r("transform");
      return (
        ...
        (e.click = function (t) {
          ...
          /(SELECT|INPUT|TEXTAREA)/i.test(e.tagName) ||
            ((s = i.createEvent("MouseEvents")).initMouseEvent(
              "click",
              !0,
              !0,
              t.view,
  ...
  function n(s, e) {
    for (var n in ((this.wrapper =
      "string" == typeof s ? i.querySelector(s) : s),
  ...
  (n.prototype = {
            ...
            if (
              ...
              (this.currentPage = d),
                (c =
                  ...
                  s.max(
                    s.max(
                      s.min(s.abs(r - d.x), 1e3),
                      s.min(s.abs(h - d.y), 1e3)
                    ),
                    300
                  )),
                (r = d.x),
    ...
    scrollToElement: function (t, i, e, n, r) {
      if ((t = t.nodeType ? t : this.scroller.querySelector(t))) {
        ...
        (h.left -= this.wrapperOffset.left),
          ...
          !0 === n &&
            (n = s.round(t.offsetHeight / 2 - this.wrapper.offsetHeight / 2)),
          (h.left -= e || 0),
          (h.top -= n || 0),
          (h.left =
            h.left > 0
              ...
              : h.left),
          (h.top =
            h.top > 0 ? 0 : h.top < this.maxScrollY ? this.maxScrollY : h.top),
          (i =
            null == i || "auto" === i
              ? s.max(s.abs(this.x - h.left), s.abs(this.y - h.top))
              : i),
    ...
    getComputedPosition: function () {
      ...
      return (
        this.options.useTransform
          ? ((i = +(
              (e = e[o.style.transform].split(")")[0].split(", "))[12] || e[4]
            )),
            (s = +(e[13] || e[5])))
      ...
      if (this.enabled) {
        ...
        switch (
          ...
          (this.keyAcceleration =
            h - a < 200 ? s.min(this.keyAcceleration + 0.25, 50) : 0),
          t.keyCode)
        ) {
          case this.options.keyBindings.pageUp:
            this.hasHorizontalScroll && !this.hasVerticalScroll
              ? (n += e ? 1 : this.wrapperWidth)
              : (r += e ? 1 : this.wrapperHeight);
            break;
          ...
          case this.options.keyBindings.end:
            (n = e ? this.pages.length - 1 : this.maxScrollX),
              (r = e ? this.pages[0].length - 1 : this.maxScrollY);
            break;
    ...
    return (
      c.outerHeight() <= e.outerHeight() &&
        ...
        f.shadow &&
          d.css({
            "-moz-box-shadow":
              "0 20px 30px -20px rgba(0,0,0," + f.shadowOpacity + ")",
            "-webkit-box-shadow":
              "0 20px 30px -20px rgba(0,0,0," + f.shadowOpacity + ")",
            "box-shadow":
              "0 20px 30px -20px rgba(0,0,0," + f.shadowOpacity + ")",
        ...
        e.on("load resize footerRevealResize", function () {
          c.css({ width: d.outerWidth() }),
            d.css({ "margin-bottom": c.outerHeight() });
        })),
      this
    );
  };
